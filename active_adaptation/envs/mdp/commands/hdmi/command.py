...
class RobotObjectTracking(RobotTracking):
    def __init__(
        ...
        # for contact rewards
        contact_eef_body_name: List[str] = ["wrist_roll_l_link", "wrist_roll_r_link"],                  # G1: ["left_wrist_yaw_link", "right_wrist_yaw_link"],
        contact_frc_eef_body_name: List[str | List[str]] = ["wrist_roll_l_link", "wrist_roll_r_link"],  # G1: ["left_wrist_(roll|pitch|yaw)_link", "right_wrist_(roll|pitch|yaw)_link"],
